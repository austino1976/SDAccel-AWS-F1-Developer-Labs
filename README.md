...
These labs are based on SDAccel 2019.2 available with the FPGA Developer AMI v1.7.0. Please make sure to select this version when you launch your instance. To find this AMI, search for "FPGA Developer AMI - 1.7.0" in the Community AMIs.
